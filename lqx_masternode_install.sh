...
COIN_TGZ="https://lqxcoin.com/assets/downloads/x86_64-pc-linux-gnu.tar.gz"
...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-lqx"
  cd $CONFIGHOME
  git clone https://github.com/azulay/sn.git $SENTINEL_PATH
  cd $SENTINEL_PATH
